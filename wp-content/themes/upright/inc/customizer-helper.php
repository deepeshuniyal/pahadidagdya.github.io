 ...
 * @return int
 */
function upright_sanitize_checkbox( $value ) {
	$value = (int) $value;
 ...
 * @return bool
 */
function upright_sanitize_checkbox_js( $value ) {
	$value = (int) $value;
 ...
 * @return mixed|null
 */
function upright_sanitize_choice( $value, $field ) {
	$default = null;
	$choices = array();
 ...
 * @return array
 */
function upright_choice_taxonomy( $taxonomy = 'category' ) {
...
/**
 * Return array of Google Webfonts.
 *
 * @return array
 */
function upright_choice_font() {
