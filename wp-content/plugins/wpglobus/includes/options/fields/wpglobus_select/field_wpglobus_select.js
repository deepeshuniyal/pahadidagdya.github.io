...
(function( $ ) {
    ...
    redux.field_objects.wpglobus_select = redux.field_objects.wpglobus_select || {};

    redux.field_objects.wpglobus_select.init = function( selector ) {
        if ( !selector ) {
            selector = $( document ).find( '.redux-container-wpglobus_select:visible' );
        }
                    ...
                    function() {
                        ...
                        if ( $( this ).hasClass( 'font-icons' ) ) {
                            default_params = $.extend(
                                {}, {
                                    formatResult: redux.field_objects.wpglobus_select.addIcon,
                                    formatSelection: redux.field_objects.wpglobus_select.addIcon,
    ...
    redux.field_objects.wpglobus_select.addIcon = function( icon ) {
