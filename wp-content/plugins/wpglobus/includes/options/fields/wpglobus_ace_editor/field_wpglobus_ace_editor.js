...
(function( $ ) {
    ...
    redux.field_objects.wpglobus_ace_editor = redux.field_objects.wpglobus_ace_editor || {};

    redux.field_objects.wpglobus_ace_editor.init = function( selector ) {
        if ( !selector ) {
            selector = $( document ).find( ".redux-group-tab:visible" ).find( '.redux-container-wpglobus_ace_editor:visible' );
        }
