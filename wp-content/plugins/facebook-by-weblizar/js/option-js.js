	...
	function feed_specificChanged()
{
   ...
   function ffp_effect_change()
   {
	    if(jQuery("#ffp_gallery_effect_name").val()=='image_move_effect')
	   {
		   ...
		   jQuery("#ffp_gallery_effect option[value='imghvr-shutter-in-horiz']").attr("selected","selected");
		   jQuery(".image_move_effect").show(); 
           jQuery(".border_effect").hide();	
           jQuery(".overlay_slide").hide();		   
	   }
	   ...
	   {
		   jQuery("#ffp_gallery_effect").find('option').removeAttr("selected");
		   jQuery("#ffp_gallery_effect option[value='outline-border']").attr("selected","selected");
		   jQuery(".image_move_effect").hide(); 
           jQuery(".border_effect").show();	
           jQuery(".overlay_slide").hide();		   
	   }
	   ...
	   {
		   jQuery("#ffp_gallery_effect").find('option').removeAttr("selected");
		   jQuery("#ffp_gallery_effect option[value='effct-veraison-1 content--c3']").attr("selected","selected");
		   jQuery(".image_move_effect").hide(); 
           jQuery(".border_effect").hide();	
           jQuery(".overlay_slide").show();		   
	   }
   ...
   function ffp_video_light_box_func()
   {
	...
	{	
	 ...
	 jQuery('.video_light_box').click(function(){
       ...
       if(jQuery("#ffp_timeline_videos").is(":checked")||jQuery("#ffp_timeline_events").is(":checked")) 
	   {
	...
	{	
		...
		jQuery.ajax({
			...
			data : jQuery("form#weblizar_feed_setting_option").serialize() + "&security=" + security,
			dataType: "html",
